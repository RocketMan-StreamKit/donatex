...
| `NETWORK_SIGNALR` | Outbound SignalR hub connections |
...
| `DASHBOARD_CHAT` | Push messages to the chat dashboard; `onChatSend` |
| `DASHBOARD_CHAT_SEND` | Dispatch outgoing chat via `sendChatMessage` |
